...
const chance = new _chance2.default(); /* eslint-disable react/no-multi-comp */
...
(0, _storybook.storiesOf)('Edit item').addDecorator(_knobs.withKnobs).add('PopOver', () => {
  return _react2.default.createElement(
    'div',
    { style: overflowHidden, id: 'myScrollContainerId' },
    ...
    _react2.default.createElement(
      _sanity2.default,
      { part: 'part:@sanity/components/edititem/popover', propTables: [_popover2.default] },
      _react2.default.createElement(
        _popover2.default,
        {
          title: (0, _knobs.text)('title (prop)', 'Edit this item'),
