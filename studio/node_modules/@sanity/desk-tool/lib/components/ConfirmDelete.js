...
exports.default = (0, _enhanceWithReferringDocuments2.default)((_temp2 = _class = class ConfirmDelete extends _react2.default.PureComponent {
  ...
  render() {
    ...
    const actions = [canContinue && { name: 'confirm', title: hasReferringDocuments ? 'Try to delete anyway' : 'Delete now' }, { name: 'cancel', title: 'Cancel', kind: 'secondary' }].filter(Boolean);
